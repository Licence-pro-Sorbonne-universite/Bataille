...
public class Bataille {
	...
	public static void bataille(Joueur joueur1, Joueur joueur2 ) {
		//Vérifier si il y a encore des cartes dans le tas 
		//Tirer des cartes
		//Les comparer 
		//Dernière option ne correspond pas au vrai jeu de Bataille, je ne savais pas comment "automatiser" le traitement d'une double/triple/quadruple ect bataille
